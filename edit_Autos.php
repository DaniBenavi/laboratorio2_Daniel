...
if (isset($_POST['btn-update'])) {
    ...
    if ($query->rowCount() > 0) {
        $msg ='<div class="alert alert-danger" role="alert">¡Esta Matricula ya está registrada!</div><a href=""><button type="button" class="btn btn-success btn-sm">OK</button><br></a>';
       //$msg= '<div class="modal-dialog modal-sm">¡Esta Matricula ya está registrada!</div>';
    } else if ($crud->update($idAuto, $matricula, $marca, $modelo, $color, $precio)) {
        ...
        <div class="row justify-content-center">
            <div class="col-6 p-5 bg-white shadow-lg rounded">
                ...
                <form method="post">
                    ...
                    <a href="admin_Autos.php"><button type="button" class="btn btn-danger">Cancelar</button><br></a>
                </form>
            </div>
