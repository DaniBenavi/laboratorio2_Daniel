            ...
            <div class="col-8 p-5 bg-white shadow-lg rounded">
                ...
                if (isset($_POST['registro'])) {
                    ...
                    if ($query->rowCount() == 0) {
                        ...
                        if ($result) {
                            echo '<div class="alert alert-success" role="alert">¡Tu registro fue exitoso!</div><a href="admin_users.php"><button type="button" class="btn btn-success btn-sm">OK</button><br></a>';
                        } else {
                            echo '
                <div class="alert alert-danger" role="alert">
                ¡Algo salió mal!
