            ...
            <div class="col-8 p-5 bg-white shadow-lg rounded">
                ...
                if (isset($_POST['registro'])) {
                    ...
                    if ($query->rowCount() > 0) {
                        ...
                        ¡Esta Matricula ya está registrada!
                        </div> <a href="new_Auto.php"><button type="button" class="btn btn-success btn-sm">OK</button><br></a>';
                    }
                    ...
                    if ($query->rowCount() == 0) {
                        ...
                        if ($result) {
                            ...
                            <a href="admin_Autos.php"><button type="button" class="btn btn-success btn-sm">OK</button><br></a>';
                        } else {
